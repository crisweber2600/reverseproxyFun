...
namespace ReverseProxyApplication
{
    public class ReverseProxyMiddleware
    {
        ...
        private void CopyFromOriginalRequestContentAndHeaders(HttpContext context, HttpRequestMessage requestMessage)
        {
            ...
            requestMessage.Headers.Add("Authorization", "Bearer eyJrIjoiZUYxTHVsNEpvR0d4S3hKdGZxNXVlYVc3NWs1ejRYRUQiLCJuIjoidGVzdCIsImlkIjoxfQ==");
        }
        ...
        private Uri BuildTargetUri(HttpRequest request)
        {
            ...
            if (request.Path.StartsWithSegments("/grafana", out remainingPath))
            {
                targetUri = new Uri("http://localhost:3000/grafana" + remainingPath);
            }
